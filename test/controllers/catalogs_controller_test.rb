...
class CatalogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post catalogs_url, params: { catalog: { characteristic: @catalog.characteristic, folder: @catalog.folder, name: @catalog.name, type: @catalog.type } }
    end
  ...
  test "should update catalog" do
    patch catalog_url(@catalog), params: { catalog: { characteristic: @catalog.characteristic, folder: @catalog.folder, name: @catalog.name, type: @catalog.type } }
